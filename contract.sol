...
contract BovinePersonas is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) public walletMints;

    address reserveWallet = payable(0xff54759820F07814B1aCF508A26F7be659CAd9cC);
